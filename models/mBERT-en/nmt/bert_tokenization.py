...
def encode(hi, en, tokenizer_ind, tokenizer_en, seq_length=MAX_SEQ_LENGTH):
    tokens_ind = tokenizer_ind.tokenize(tf.compat.as_text(hi.numpy()))
    lang1 = tokenizer_ind.convert_tokens_to_ids(['[CLS]'] + tokens_hi + ['[SEP]'])
